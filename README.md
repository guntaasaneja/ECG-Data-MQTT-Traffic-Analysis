...
Created for MQTT protocol analysis and network performance evaluation.
...
1. Check existing files in `WiresharkData/` and `WiresharkOldData/`
2. Verify tshark installation: `tshark --version`
3. Ensure Python dependencies: `pip list | grep pandas`
4. Review makefile for build options: `make help`
